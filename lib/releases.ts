...
export const releases: Release[] = [
  {
    ...
    ext: ".dmg",
    url: "https://drive.google.com/file/d/1P2xRUFQ-wHFRNzAJBxQchd6lbGQYuB2z/view?usp=sharing",
    size: "~400 MB",
    available: true,
  },
  {
    ...
    sublabel: "Intel (x64)",
    ext: ".dmg",
    url: "https://drive.google.com/file/d/18cBsL77aUAdCY07Vcq0CBBubU0DApCk7/view?usp=sharing",
    size: "~400 MB",
    available: true,
  },
  {
